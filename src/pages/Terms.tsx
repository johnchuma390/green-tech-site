        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="glass-card rounded-2xl p-8 md:p-12">
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">2. Registration and Payment</h2>
              <p className="text-muted-foreground mb-6">
                All registration fees must be paid in full before the conference. Registration fees are 
                non-refundable except as specified in our cancellation policy. We reserve the right to 
                refuse or cancel registrations at our discretion.
              </p>

              <h2 className="text-2xl font-heading font-bold mb-4">3. Cancellation Policy</h2>
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">4. Code of Conduct</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">5. Intellectual Property</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">6. Photography and Media</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">7. Liability</h2>
              <p className="text-muted-foreground mb-6">
              ...
              <h2 className="text-2xl font-heading font-bold mb-4">8. Changes to Event</h2>
              <p className="text-muted-foreground mb-6">
                We reserve the right to modify the conference program, speakers, schedule, or venue. 
                In case of cancellation due to circumstances beyond our control, we will provide 
                appropriate refunds or alternatives.
              </p>

              <h2 className="text-2xl font-heading font-bold mb-4">9. Contact</h2>
              <p className="text-muted-foreground">
                For questions about these terms, please contact us at{' '}
                <a href="mailto:legal@greentechconf.org" className="text-primary hover:underline">
                  legal@greentechconf.org
                </a>
              </p>
            </div>
          </motion.div>
